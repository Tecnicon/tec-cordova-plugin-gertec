...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stGedi = findViewById(R.id.st_gedi);
        stGand = findViewById(R.id.st_gand);
        stPPComp = findViewById(R.id.st_ppComp);
        stGrc = findViewById(R.id.st_grc);
        stGoc = findViewById(R.id.st_goc);
        stTransact = findViewById(R.id.st_transact);
